...
public class ApplicationController implements ApplicationApi {
    ...
    //NEF
    //Design rule violation: UseObjectForClearerAPI
    //replaced long param list in public method with object that contains those types 
    ApplicationInfo response = new ApplicationInfo(String partnerID, String processID, String rollType);
    public ResponseEntity<ModelApiResponse> deleteProcessConfiguration(ApplicationInfo response, @ApiParam(value = "The Bearer token provided by the identity service" ,required=true ) @RequestHeader(value="Authorization", required=true) String bearerToken
    ) throws NimbleException {
        // set request log of ExecutionContext
