...
public abstract class AbstractCommand extends Message{
    ...
    //NEF design rule fix for ExcessiveParamenterList
    //replaced some params with an object and added new class for it
    CommandDetails cmdInfo = new CommandDetails();
    public AbstractCommand(String subject, CommandDetails cmdInfo, String GTX, String LTX, String FLTX, String PGTX, String additionalHeaders) {
