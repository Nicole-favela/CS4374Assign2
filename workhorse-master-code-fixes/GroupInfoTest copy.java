...
public class GroupInfoTest {
    ...
    @Test
    //NEF MethodNamingConvention fixed to camel case 
    public void testGroupInfoNoExecutions() {
    ...
    @Test
    //NEF methodNamingConvention fixed 
    public void testGroupInfoDesaster() {
    ...
    @Test
    //NEF: MethodNamingConventions code style 
    public void testGroupInfoAborted() {//changed to camel case
