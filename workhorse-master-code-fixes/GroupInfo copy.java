...
public class GroupInfo {
    ...
    public GroupInfo() {}
    //NEF: shortvarible: code style violation fixed
    public GroupInfo(Long identification, List<JobExecutionInfo> executionInfos) {
    ...
    //NEF: fix short varible name 
    public void setId(Long identification) {//originally Long id
        this.id = identification;
    }
